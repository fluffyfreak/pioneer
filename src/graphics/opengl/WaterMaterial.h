...
#ifndef _OGL_WATERMATERIAL_H
#define _OGL_WATERMATERIAL_H
/*
...
namespace Graphics {
	namespace OGL {
		class WaterProgram : public Program {
		public:
			WaterProgram(const std::string &filename, const std::string &defines);
