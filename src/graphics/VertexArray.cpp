...
void VertexArray::Add(const vector3f &v, const vector3f &n, const vector3f &t)
{
	PROFILE_SCOPED()
	position.push_back(v);
	normal.push_back(n);
...
void VertexArray::Set(const Uint32 idx, const vector3f &v, const vector3f &n, const vector3f &t)
{
	PROFILE_SCOPED()
	position[idx] = v;
	normal[idx] = n;
