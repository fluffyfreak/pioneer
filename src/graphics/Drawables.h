...
public:
	TexturedQuad(Graphics::Renderer *r, Graphics::Texture *texture, const vector2f &pos, const vector2f &size, RenderState *state, const bool bInverted = false);
	TexturedQuad(Graphics::Renderer *r, Graphics::Texture *texture, Graphics::Material *material, const vector2f &pos, const vector2f &size, RenderState *state);
	virtual void Draw(Graphics::Renderer *r) { 
