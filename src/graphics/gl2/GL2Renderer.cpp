...
Material* RendererGL2::GetShadowMaterial() const
{
	return m_shadowMaterial.Get();
}

void RendererGL2::SetShadowMatrix(const matrix4x4f &shadowMatrix)
{
...
void RendererGL2::SetShadowTexture(Texture *shadowTexture)
{
	m_shadowTexture.Reset(shadowTexture);
}

Texture* RendererGL2::GetShadowTexture() const
{
