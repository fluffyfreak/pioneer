...
public:
	...
	virtual bool DrawPointSprites(const Uint32 count, const vector3f *positions, const vector2f *prevOffsets, const vector2f *currOffsets, const float *blends, const float *sizes, RenderState *rs, Material *material) = 0;
