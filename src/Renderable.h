...
public:
	...
	void SetRenderState(Graphics::RenderState *rs) { m_renderState = rs; } 
	bool HasRenderState() const { return m_renderState!=nullptr; }

	virtual void Draw(Graphics::RenderState *rs) = 0;

protected:
	Renderable(Graphics::Renderer *r, Graphics::RenderState *rs) : m_renderer(r), m_renderState(rs), m_transform(matrix4x4f::Identity()) {}
...
public:
	TriangleGraphic(Graphics::Renderer*, Graphics::RenderState*, Graphics::VertexArray*, RefCountedPtr<Graphics::Material>, Graphics::PrimitiveType = Graphics::TRIANGLES);
	...
	virtual void Draw(Graphics::RenderState *rs) override final;
...
public:
	LaserGraphic(Graphics::Renderer *r, Graphics::RenderState*);
