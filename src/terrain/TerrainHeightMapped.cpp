...
template <>
void TerrainHeightFractal<TerrainHeightMapped>::GetHeights(const std::vector<vector3d> &positions, std::vector<double> &heightsOut) const
{
