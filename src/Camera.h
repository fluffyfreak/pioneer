...
public:
	...
	void ApplyDrawTransforms(Graphics::Renderer *r, const ViewEye eye = ViewEye_Centre);
...
public:
	...
	void Update();
	void Draw(const Body *excludeBody = nullptr, ShipCockpit* cockpit = nullptr, const ViewEye eye = ViewEye_Centre);
