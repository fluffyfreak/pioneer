...
public:
	...
	virtual void SetLabel(const std::string &label) override final;
	...
	virtual void TimeStepUpdate(const float timeStep) override final;
	virtual bool OnCollision(Object *o, Uint32 flags, double relVel) override final;
	virtual bool OnDamage(Object *attacker, float kgDamage, const CollisionContact& contactData) override final;
protected:
