...
OrbitalViewerView::OrbitalViewerView(): View()
{
	...
	Gui::LabelButton *b = new Gui::LabelButton(new Gui::Label("Change orbital terrain type"));
	b->onClick.connect(sigc::mem_fun(this, &OrbitalViewerView::OnChangeGeoRingStyle));
	vbox->PackEnd(b);
}

void OrbitalViewerView::Draw3D()
{
	static float rot;
	rot += 0.1;
...
void OrbitalViewerView::OnChangeGeoRingStyle()
{
