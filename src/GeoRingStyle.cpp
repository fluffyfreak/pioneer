 ...
 */
static inline double octavenoise(ringfracdef_t &def, double roughness, const vector3d &p);
static inline double river_octavenoise(ringfracdef_t &def, double roughness, const vector3d &p);
static inline double ridged_octavenoise(ringfracdef_t &def, double roughness, const vector3d &p);
static inline double billow_octavenoise(ringfracdef_t &def, double roughness, const vector3d &p);
static inline double voronoiscam_octavenoise(ringfracdef_t &def, double roughness, const vector3d &p);
static inline double dunes_octavenoise(ringfracdef_t &def, double roughness, const vector3d &p);
//static inline double dunes_octavenoise(int octaves, double roughness, double lacunarity, const vector3d &p);
static double canyon_ridged_function(const ringfracdef_t &def, const vector3d &p);
static double canyon2_ridged_function(const ringfracdef_t &def, const vector3d &p);
static double canyon3_ridged_function(const ringfracdef_t &def, const vector3d &p);
static double canyon_normal_function(const ringfracdef_t &def, const vector3d &p);
static double canyon2_normal_function(const ringfracdef_t &def, const vector3d &p);
static double canyon3_normal_function(const ringfracdef_t &def, const vector3d &p);
static double canyon_voronoi_function(const ringfracdef_t &def, const vector3d &p);
static double canyon2_voronoi_function(const ringfracdef_t &def, const vector3d &p);
static double canyon3_voronoi_function(const ringfracdef_t &def, const vector3d &p);
static double canyon_billow_function(const ringfracdef_t &def, const vector3d &p);
static double canyon2_billow_function(const ringfracdef_t &def, const vector3d &p);
static double canyon3_billow_function(const ringfracdef_t &def, const vector3d &p);
static double crater_function(const ringfracdef_t &def, const vector3d &p);
static double impact_crater_function(const ringfracdef_t &def, const vector3d &p);
static double volcano_function(const ringfracdef_t &def, const vector3d &p);
static double megavolcano_function(const ringfracdef_t &def, const vector3d &p);
static double river_function(const ringfracdef_t &def, const vector3d &p);
static double river2_function(const ringfracdef_t &def, const vector3d &p);
static double cliff_function(const ringfracdef_t &def, const vector3d &p);

int GeoRingStyle::GetRawHeightMapVal(int x, int y)
{
	//PROFILE_SCOPED()
 ...
 */
double GeoRingStyle::GetHeightMapVal(const vector3d &pt)
{   
	//PROFILE_SCOPED()
...
void GeoRingStyle::PickAtmosphere(const SBody *sbody)
{
	//PROFILE_SCOPED()
...
void GeoRingStyle::InitHeightMap(const SBody *body)
{
	//PROFILE_SCOPED()
	/* Height map? */
...
GeoRingStyle::GeoRingStyle(const SBody *body)
{
	//PROFILE_SCOPED()
	MTRand rand;
	rand.seed(body->seed);
 ...
 */
void GeoRingStyle::SetFracDef(struct ringfracdef_t *def, double featureHeightMeters, double featureWidthMeters, MTRand &rand, double smallestOctaveMeters)
{
	//PROFILE_SCOPED()
	// feature 
...
void GeoRingStyle::InitFractalType(MTRand &rand)
{
	//PROFILE_SCOPED()
 ...
 */
double GeoRingStyle::GetHeight(const vector3d &p)
{
	//PROFILE_SCOPED()
...
/* These fuctions should not be used by GeoRingStyle::GetHeight, so don't move these definitions
   to above that function. GetHeight should use the versions of these functions that take ringfracdef_t
 ...
 */
vector3d GeoRingStyle::GetColor(const vector3d &p, double height, const vector3d &norm)
{
	//PROFILE_SCOPED()
	switch (m_colorType) {
	case COLOR_NONE:
...
// Larger canyon.
double canyon2_ridged_function(const ringfracdef_t &def, const vector3d &p)
{
	double h;
...
double canyon3_ridged_function(const ringfracdef_t &def, const vector3d &p)
{
	double h;
...
double canyon2_normal_function(const ringfracdef_t &def, const vector3d &p)
{
	double h;
	double n = 0;
...
double canyon3_normal_function(const ringfracdef_t &def, const vector3d &p)
{
	double h;
	double n = 0;
...
double canyon2_voronoi_function(const ringfracdef_t &def, const vector3d &p)
{
	double h;
	double n = 0;
	n = octavenoise(def.octaves, 0.56, 2.0, def.frequency*p);
...
double canyon3_voronoi_function(const ringfracdef_t &def, const vector3d &p)
{
	double h;
	double n = 0;
	n = octavenoise(def.octaves, 0.585, 2.0, def.frequency*p);
...
double canyon2_billow_function(const ringfracdef_t &def, const vector3d &p)
{
	double h;
	double n = 0;
	n = octavenoise(def.octaves, 0.56, 2.0, def.frequency*p);
...
double canyon3_billow_function(const ringfracdef_t &def, const vector3d &p)
{
	double h;
	double n = 0;
	n = octavenoise(def.octaves, 0.585, 2.0, def.frequency*p);
...
/*double rock_function(const ringfracdef_t &def, const vector3d &p)
{
	double h;
...
double river_function(const ringfracdef_t &def, const vector3d &p)
{
	double h;
...
// Wider river.
double river2_function(const ringfracdef_t &def, const vector3d &p)
{
	double h;
	double n = octavenoise(def.octaves, 0.585, 2.0, def.frequency*p*0.5);
...
double cliff_function(const ringfracdef_t &def, const vector3d &p)
{
	double h;
