...
void ModelViewer::GenerateAsteroid()
{
	...
	m_asteroidMap[0].reset(Graphics::TextureBuilder::Model("textures/asteroid/Pumice-diffusePacked.png").GetOrCreateTexture(m_renderer, "Asteroid"));
	m_asteroidMap[1].reset(Graphics::TextureBuilder::Model("textures/asteroid/Pumice-nsAOPacked.png").GetOrCreateTexture(m_renderer, "Asteroid"));
	m_asteroidMap[2].reset(Graphics::TextureBuilder::Model("textures/asteroid/Stones-diffusePacked.png").GetOrCreateTexture(m_renderer, "Asteroid"));
	m_asteroidMap[3].reset(Graphics::TextureBuilder::Model("textures/asteroid/Stones-nsAOPacked.png").GetOrCreateTexture(m_renderer, "Asteroid"));
	...
	m_asteroid.reset(new Asteroid(m_renderer, mat, m_renderer->CreateRenderState(rsDesc), deformations, 6, m_model->GetDrawClipRadius()));
