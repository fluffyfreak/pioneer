...
typedef void (*resize_callback)(SDL_Window* /*window*/, int w, int h);
IMGUI_API bool        ImGui_ImplSdlVulkan_Init(SDL_Window* window, resize_callback callback, ImGui_ImplSdlVulkan_Init_Data *init_data);
IMGUI_API void        ImGui_ImplSdlVulkan_Shutdown();
IMGUI_API void        ImGui_ImplSdlVulkan_NewFrame();
